...
require_once('func_getsqlvaluestring.php'); 
 ...
 $insertSQL = sprintf("INSERT INTO reqitens (req_id, reqitemid, reqitqnt) VALUES (%s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['itemqnt'], "text"));
...
mysql_select_db($database_conexao, $conexao);
$query_RsRequisicaoItens = "SELECT * FROM vw_reqitens WHERE req_id=".$reqid."";
...
<div role="main" class="ui-content"> 
  <ul data-role="listview" data-split-icon="delete" data-theme="a" data-split-theme="b" data-inset="true">
   ...
   <a href="requisicao_itens_del.php?reqitid_del=<?php echo $row_RsRequisicaoItens['reqitid'];  ?>" data-position-to="window" >Purchase album</a>
   </li>
